...
## [ Сценарий - Экспорт нескольких тем/ пакета ]
...
1. **Вариант 1**: Пользователь выбрал формат `.txt`.
    ...
    1. Система закрывает диалоговое окно.
1. **Вариант 1**: Пользователь выбрал формат `.themes` (собственный формат
   приложения; полученный файл может быть впоследствии экспортирован).
   *Примечание: при это выборе, будет экспортированна информация как о самих темах,
   так и о пакетах, в которых они содержатся.*
    1. Система закрывает диалоговое окно.
1. Система экспортирует темы, учитывая выбранные Пользователем параметры.
