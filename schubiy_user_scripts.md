...
1. Пользователь вводит название темы/ пакета/ графа (опционально).
1. Пользователь выбирает название пакета тем из выпадающего списка (опционально; только для поиска по темам).
1. Пользователь выбирает нужно ли выводить изученные темы (опционально; только для поиска по темам).
1. Пользователь выбирает нужно ли выводить темы из списка "Изучить Позже" (опционально; только для поиска по темам).
1. Пользователь включает или выключает режим авто-обновления.
...
1. Сценарий может быть начат двумя способами:
    ...
    1. **Способ 2 (создание)**:
        ...
        <!-- TODO способ 3: создание в графе -->
...
<!-- TODO создание пакета -->
1. **Вариант 1**: Пользователь не вносит изменений ни в одно из полей:
    1. Пользователь закрывает окно.
    1. Сценарий завершается.
1. **Вариант 2:** Пользователь вносит изменения в некоторые поля:
...
1. **Вариант 1**: Пользователь не вносит изменений в граф:
    1. Сценарий завершается.
1. **Вариант 2**: Пользователь вносит изменения в граф:
    <!-- TODO перемещение/ увеличение холста -->
    <!-- TODO перемещение/ увеличение холста -->
    1. Для этого пользователь выбирает один из режимов редактирования, нажимая
    ...
    1. При закрытии графа система выводит окно с вопросом о необходимости сохранения.
