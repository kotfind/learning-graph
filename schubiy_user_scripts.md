...
## [ Сценарий - Построение и экспорт списка изучения ]
...
1. **Вариант 2**: Пользователь выбрал формат `.graph` (собственный формат
   ...
   *Примечание: при это выборе, будет экспортированна информация как о графе,
...
## [ Сценарий - Экспорт нескольких тем/ пакета/ списка изучения ]
...
1. **Вариант 2**:
    ...
    1. Пользователь нажиамает правой кнопкой мыши по нужному пакету.
    1. Система выводит меню &mdash; список возможных действий над пакетом.
    1. Пользователь выбирает пункт "Экспортировать".
    1. *Примечание: будут выбраны все темы, содержащися в данном пакете.*
1. **Вариант 3**:
...
1. **Вариант 2** (только для экспорта пакета или набора тема): Пользователь
   ...
   экспортированна информация как о самих темах, так и о пакетах, в которых они
   содержатся.*
    1. Система закрывает диалоговое окно.
1. Система экспортирует данные, учитывая выбранные Пользователем параметры.

## [ Сценарий - Импорт пакета/ набора тем ]

1. Пользовать переходит во вкладку "Темы" или "Пакеты".
    ...
    1. **Цикл** (следующие действия выполняются для каждого пакета из файла):
        ...
        1. **Вариант 2**: Пакет с таким именем существует.
            ...
            1. **Вариант 2**: Пользователь выбирает вариант "Переименовать".
                1. Выбирается новое имя, анологично сценарию *[ Создание/ переименование пакета/ графа ]*.
...
## [ Сценарий - Импорт графа ]

1. Пользовать переходит во вкладку "Графы".
1. Пользователь нажимает кнопку импорта.
1. Система выводит диалоговое окно для выбора файла.
1. Пользователь выбирает файл.
1. Система закрывает диалоговое окно.
...
1. **Вариант 2**: Файл является корректным.
    ...
    1. **Вариант 2**: Граф с таким именем существует.
        1. Конфликт разрещается аналогично конфликту при импорте темы
